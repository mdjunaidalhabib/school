  ...
  return (
    ...
    <div
      ...
      />
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">Student's Arabic Name</label>
            <input
              type="text"
              name="arabicName"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">Student's NID </label>
            <input
              type="text"
              name="nid"
              value={formData.nid}
...
{/* একাডেমিক বিভাগ নির্বাচন */}
      ...
      <div className="bg-gray-100 px-6 rounded-md mt-6">
        ...
        <div className="grid grid-cols-4 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">Father's Arabic Name</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">Father's NID</label>
            <input
              type="text"
              name="fatherNid"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">Mother's NID</label>
            <input
              type="text"
              name="motherNid"
      ...
      <div>
      <ThanaSelect districtId={selectedDistrict} onSelect={setSelectedThana} 
...
{alert && (
  <div className={`fixed top-4 left-4 right-4 p-1 rounded-md text-center text-white shadow-md transition-all duration-500 ${fade ? "opacity-100" : "opacity-0"} ${
    alert?.type?.toLowerCase() === "success" ? "bg-green-500" : "bg-red-500"
  }`}>
    {alert.message}
  </div>
)}
