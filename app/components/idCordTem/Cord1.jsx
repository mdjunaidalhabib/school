    ...
    <div>
      <div className="w-[280px] h-[440px] bg-white overflow-hidden">
        <div className="relative w-[300px] h-[472px]">
          ...
          <div className="absolute top-48 w-full flex justify-center items-center [font-family:'Inter-Bold',Helvetica] font-bold text-black text-base text-center tracking-[0] leading-[normal] whitespace-nowrap">
            MD JUNAID AL HABIB
          </div>
